...
that arrival starts the punch loop again. What still belongs above the
transport is a *stream* that dies mid-request: reissuing it is resume,
and it arrives with the File API's ranged reads.
